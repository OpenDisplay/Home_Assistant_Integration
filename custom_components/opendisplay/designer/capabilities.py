...
if TYPE_CHECKING:
    from custom_components.opendisplay import OpenDisplayConfigEntry
...
def build_capabilities(
    ...
    *,
    ...
    colors = (
        palette.colors if isinstance(palette, ColorPalette) else palette.palette.colors
    )
    ...
    accent = (
        palette.accent if isinstance(palette, ColorPalette) else scheme.accent_color
    )
    return {
        "device_id": device_id,
        "pixel_width": pw,
