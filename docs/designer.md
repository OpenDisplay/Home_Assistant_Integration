...
The current pins are the designer at **3.4.1** and `js-yaml` at **4.1.0**
...
expected to show the designer version now. Every type and member the
wrapper reads or writes has been re-checked against the 3.4.1 `.d.ts`
