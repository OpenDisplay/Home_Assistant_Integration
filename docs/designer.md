...
The current pins are the designer at **3.4.2** and `js-yaml` at **4.1.0**
...
— no embed-surface change. Every type and member the wrapper reads or
writes has been re-checked against the 3.4.2 `.d.ts`
